...
public class S3Storage {
    ...
    @Retryable(
            retryFor = {ProfileUploadFailException.class, Throwable.class, AwsServiceException.class, SdkClientException.class},
            recover = "recover",
    ...
    public void upload(MultipartFile file,String key) {
        ...
        try {
            ...
            throw new ProfileUploadFailException(ErrorCode.PROFILE_UPLOAD_FAIL, Map.of("key", key,"exceptionName",e.getClass().getSimpleName(),"exception",e));
    ...
    @Recover
    public UUID recover(ProfileUploadFailException e, String key) {
        log.info("S3 업로드 실패");
        throw new ProfileUploadFailException(ErrorCode.PROFILE_UPLOAD_FAIL, Map.of("key",key));
    }
