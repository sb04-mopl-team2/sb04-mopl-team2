package com.codeit.mopl.batch.tmdb.movie.config;
  ...
  public Tasklet dailyMovieUpdateTasklet() {
    return (contribution, chunkContext) -> {
      ...
      TmdbDiscoverMovieResponse firstPageResponse =
          movieApiService.discoverContentFromDateWithResponse(tomorrow, 1).block();
      ...
      for (int page = 2; page <= maxPages; page++) {
        movieApiService.discoverContentFromDate(tomorrow, page).block();
        Thread.sleep(1000);
      }
