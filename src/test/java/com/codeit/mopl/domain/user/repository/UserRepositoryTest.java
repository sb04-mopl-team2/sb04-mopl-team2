...
public class UserRepositoryTest {
    ...
    void findAllPage1() {
        ...
        Slice response = userRepository.findAllPage(request);
    ...
    @DisplayName("sortBy role, 정방향 정렬, cursor user 그외 null -> 최초 1건 isLocked = false")
    @Test
    ...
    @DisplayName("sortBy role, 역방향 정렬, cursor user 그외 null -> 최초 1건 isLocked = false")
    @Test
